...
class TestingMain:
    ...
    def dumbbellRows(self, filename_input):
        ...
        count = 0
        dir = 0
        pTime = 0 # Initialize a variable to count knee angle occurrences
        counted = False
        timestamp = 0
        timestamps=[]
        ui_width = 170
        ...
        while True:
            ...
            if len(lmList) != 0:
                ...
                if distance_elbow_hips < 85:
                ...
                elif knee_angle < 50 or knee_angle > 120:
                    frame_height, frame_width = img.shape[:2]
                    lineColor = (0,0,255)
                    if knee_angle < 50:
                        text = "LEAN BACKWARD"
                    ...
                    if counted == True:
                        forwardbend = False 
                        counted = False               
                    if forwardbend == True: # Increment the count when knee angle is greater than 90
                        end_time = time.time()
                        timestamp = end_time - start_time
                        counted = True
                    
                elif backbend_angle > 70 and knee_angle < 50 or backbend_angle > 70 and knee_angle > 120:
                    frame_height, frame_width = img.shape[:2]
                    text = "YOUR BACK IS BENDING"
                    lineColor = (0,0,255)
                    position = (20, 60)
    ...
    def bentOverRows(self,filename_input):
        ...
        dir = 0
        pTime = 0
        new_arr = []# Initialize a variable to count knee angle occurrences
        counted = False
